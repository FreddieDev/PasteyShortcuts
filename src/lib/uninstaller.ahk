...
Gui Add, Text, hWndhTxt x12 y9 w471 h26 +0x200, PasteyShortcuts is already installed
Gui Font
Gui Font, s10
Gui Add, Text, x19 y37 w465 h18 +0x200, Choose how you want to proceed...
Gui Font
Gui Add, Text, x38 y138 w318 h23 +0x200, Removes PasteyShortcuts from your computer
Gui Add, Text, x37 y88 w350 h23 +0x200, Reinstalls PasteyShortcuts to replaces current version with this download
...
ButtonContinue:
	...
	if (uninstall) {
		...
		MsgBox,0,PasteyShortcuts installation, Uninstall completed!
	} else if (update) {
		Run installer.exe
	}
